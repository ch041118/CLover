...
> **2026-09-24 개편 기획:** [마이크 하나·일반 요청 자동 배정·예외 조율 기획서](docs/SERVICE-PLAN.md)를 새 개발 기준으로 정리했습니다. 개편 기능은 계획 단계이며, 아래 실행 안내는 현재 구현 기준입니다.
...
요청이 정상 저장되면 음성으로 완료를 알립니다. 어르신 홈에서 최초 동의 후 자동으로 안부를 묻고, 미확인 시 5분 간격으로 하루 최대 3회 다시 묻습니다. 앱 전면 홈 화면에서 동작하며 잠금·앱 종료 상태의 자동 통화 기능은 아닙니다. [설정과 제한 사항](docs/VOICE-CHECKIN.md)을 확인하세요.
